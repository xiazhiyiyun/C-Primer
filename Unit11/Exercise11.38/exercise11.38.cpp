...
void build_map(ifstream &map_file,unordered_map<string,string> &map_word);
string transform(const string &word,const unordered_map<string,string> &map_word);
...
void word_transform(ifstream &map_file,ifstream &input)
{
	unordered_map<string,string> map_word;
